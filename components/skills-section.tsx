      ...
      <div className="container px-4">
        ...
        >
          <div className="flex justify-center mb-8 overflow-x-auto pb-2 w-full">
            <TabsList className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-4 min-w-full sm:min-w-0">
              {skillCategories.map(category => (
                <TabsTrigger key={category.id} value={category.id} className="whitespace-nowrap px-3">
                  {category.name}
                </TabsTrigger>
              ))}
            </TabsList>
